    ...
    if (bojovnik != nullptr) {
        switch (efekt) {
            case 0:
                ...
                doSpravy = "\033[1;35m🌟 " + bojovnik->getMeno() + " dostal dvojnásobok životov 🌟\033[0m \n";
            ...
            case 1:
                ...
                doSpravy = "\033[1;33m💥 " + bojovnik->getMeno() + " dostal dvojnásobné poškodenie 💥\033[0m \n";
            ...
            case 2:
                ...
                doSpravy = "\033[1;34m🛡️ " + bojovnik->getMeno() + " dostal dvojnásobné brnenie 🛡️\033[0m \n";
